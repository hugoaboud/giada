...
#define G_COLOR_RED       fl_rgb_color(113, 31,  31)
#define G_COLOR_BLUE      fl_rgb_color(28,  32,  80)
...
#define G_CHANNEL_INPUT  0x04
#define G_CHANNEL_COLUMN 0x08
#define G_CHANNEL_MASTER 0x10
