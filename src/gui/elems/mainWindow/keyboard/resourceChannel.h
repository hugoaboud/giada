...
#ifndef GE_RESOURCE_CHANNEL_H
#define GE_RESOURCE_CHANNEL_H
...
class geResourceChannel : public geChannel
{
protected:
...
public:
	...
	geResourceChannel(int x, int y, int w, int h, int type, ResourceChannel* ch);
